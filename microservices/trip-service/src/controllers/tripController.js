...
export const getAllTrips = async (req, res) => {
  try {
    ...
    console.error('[Trip Service] Lỗi lấy danh sách chuyến đi:', error);
...
export const getTripById = async (req, res) => {
  try {
    ...
    console.error('[Trip Service] Lỗi lấy chuyến đi:', error);
    return res.status(500).json({ message: 'Lỗi hệ thống.' });
  }
};
...
export const createTrip = async (req, res) => {
  try {
    ...
    console.error('[Trip Service] Lỗi tạo chuyến đi:', error);
    return res.status(500).json({ message: 'Lỗi hệ thống.' });
  }
};
...
export const updateTrip = async (req, res) => {
  try {
    ...
    console.error('[Trip Service] Lỗi cập nhật chuyến đi:', error);
    return res.status(500).json({ message: 'Lỗi hệ thống.' });
  }
};
...
export const deleteTrip = async (req, res) => {
  try {
    ...
    console.error('[Trip Service] Lỗi xóa chuyến đi:', error);
