...
export const getAllBusTypes = async (req, res) => {
  try {
    ...
    console.error('[Catalog Service] Lỗi khi lấy danh sách loại xe:', error);
...
export const getBusTypeById = async (req, res) => {
  try {
    ...
    console.error('[Catalog Service] Lỗi khi lấy chi tiết loại xe:', error);
    return res.status(500).json({ message: 'Đã xảy ra lỗi hệ thống.' });
  }
};
...
export const createBusType = async (req, res) => {
  try {
    ...
    console.error('[Catalog Service] Lỗi khi tạo loại xe:', error);
...
export const updateBusType = async (req, res) => {
  try {
    ...
    console.error('[Catalog Service] Lỗi khi cập nhật loại xe:', error);
    return res.status(500).json({ message: 'Đã xảy ra lỗi hệ thống.' });
  }
};
...
export const deleteBusType = async (req, res) => {
  try {
    ...
    console.error('[Catalog Service] Lỗi khi xóa loại xe:', error);
