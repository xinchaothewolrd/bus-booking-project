...
CREATE TABLE `route_stops` (
  ...
  `arrive_offset_minutes` int DEFAULT '0',
  PRIMARY KEY (`id`),
...
INSERT INTO `route_stops` VALUES (1,1,'Bến xe Phan Rang','Thống Nhất, Đài Sơn, Ninh Thuận','pickup',1,0),(2,1,'Bến xe Miền Đông mới','TP Hồ Chí Minh','dropoff',2,20);
