...
export const getAllTripSeats = async (req, res) => {
  try {
    ...
    console.error('[Trip Service] Lỗi lấy danh sách ghế:', error);
...
export const getTripSeatById = async (req, res) => {
  try {
    ...
    console.error('[Trip Service] Lỗi lấy thông tin ghế:', error);
    return res.status(500).json({ message: 'Lỗi hệ thống.' });
  }
};
...
export const getSeatsByTripId = async (req, res) => {
  try {
    ...
    console.error('[Trip Service] Lỗi lấy ghế theo chuyến đi:', error);
    return res.status(500).json({ message: 'Lỗi hệ thống.' });
  }
};
...
export const createTripSeat = async (req, res) => {
  try {
    ...
    console.error('[Trip Service] Lỗi tạo ghế:', error);
...
export const updateTripSeat = async (req, res) => {
  try {
    ...
    console.error('[Trip Service] Lỗi cập nhật ghế:', error);
    return res.status(500).json({ message: 'Lỗi hệ thống.' });
  }
};
...
export const deleteTripSeat = async (req, res) => {
  try {
    ...
    console.error('[Trip Service] Lỗi xóa ghế:', error);
    return res.status(500).json({ message: 'Lỗi hệ thống.' });
  }
};
