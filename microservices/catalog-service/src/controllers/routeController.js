...
export const getAllRoutes = async (req, res) => {
  try {
    ...
    console.error('[Catalog Service] Lỗi khi lấy danh sách tuyến đường:', error);
...
export const getRouteById = async (req, res) => {
  try {
    ...
    console.error('[Catalog Service] Lỗi khi lấy tuyến đường:', error);
    return res.status(500).json({ message: 'Đã xảy ra lỗi hệ thống.' });
  }
};
...
export const createRoute = async (req, res) => {
  try {
    ...
    console.error('[Catalog Service] Lỗi khi tạo tuyến đường:', error);
...
export const updateRoute = async (req, res) => {
  try {
    ...
    console.error('[Catalog Service] Lỗi khi update tuyến đường:', error);
    return res.status(500).json({ message: 'Đã xảy ra lỗi hệ thống.' });
  }
};
...
export const deleteRoute = async (req, res) => {
  try {
    ...
    console.error('[Catalog Service] Lỗi khi xóa tuyến đường:', error);
