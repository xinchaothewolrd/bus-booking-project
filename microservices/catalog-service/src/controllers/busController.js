...
export const getAllBuses = async (req, res) => {
  try {
    ...
    console.error('[Catalog Service] Lỗi khi lấy danh sách xe khách:', error);
...
export const getBusById = async (req, res) => {
  try {
    ...
    console.error('[Catalog Service] Lỗi khi lấy xe khách:', error);
    return res.status(500).json({ message: 'Đã xảy ra lỗi hệ thống.' });
  }
};
...
export const createBus = async (req, res) => {
  try {
    ...
    console.error('[Catalog Service] Lỗi khi tạo xe khách:', error);
...
export const updateBus = async (req, res) => {
  try {
    ...
    console.error('[Catalog Service] Lỗi khi cập nhật xe khách:', error);
...
export const deleteBus = async (req, res) => {
  try {
    ...
    console.error('[Catalog Service] Lỗi khi xóa xe khách:', error);
